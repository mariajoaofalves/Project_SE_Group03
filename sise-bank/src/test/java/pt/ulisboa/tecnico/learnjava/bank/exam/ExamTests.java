...
public class ExamTests {
	...
	public void setUp() throws AccountException, ClientException, BankException {
		...
		Person otherPerson = new Person("Joao", "Manuel", "Street", "987654321");
		Client otherClient = new Client(this.bank, otherPerson, "023456789", 33);

		Person youngPerson = new Person("Joao", "Manuel", "Street", "987654321");
		this.youngClient = new Client(this.bank, youngPerson, "123456780", 17);
